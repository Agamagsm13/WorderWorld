...
import com.agamatech.worderworld.databinding.FragmentGame8Binding
...
@AndroidEntryPoint
class GameFragment8: Fragment() {

    private var binging: FragmentGame8Binding? = null
    private val args by navArgs<GameFragment6Args>()
    private val LETTERS_COUNT = 8
    ...
    private var try8Letters: List<CustomLetter>? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        val b = FragmentGame8Binding.inflate(inflater, container, false).also { binging = it }
    ...
    private fun initUi() {
        binging?.apply {
            ...
            try0Letters = listOf(l00, l01, l02, l03, l04, l05, l06, l07)
            try1Letters = listOf(l10, l11, l12, l13, l14, l15, l16, l17)
            try2Letters = listOf(l20, l21, l22, l23, l24, l25, l26, l27)
            try3Letters = listOf(l30, l31, l32, l33, l34, l35, l36, l37)
            try4Letters = listOf(l40, l41, l42, l43, l44, l45, l46, l47)
            try5Letters = listOf(l50, l51, l52, l53, l54, l55, l56, l57)
            try6Letters = listOf(l60, l61, l62, l63, l64, l65, l66, l67)
            try7Letters = listOf(l70, l71, l72, l73, l74, l75, l76, l77)
            try8Letters = listOf(l80, l81, l82, l83, l84, l85, l86, l87)
            fullWordsList = listOf(try0Letters, try1Letters, try2Letters, try3Letters, try4Letters, try5Letters, try6Letters, try7Letters, try8Letters)
